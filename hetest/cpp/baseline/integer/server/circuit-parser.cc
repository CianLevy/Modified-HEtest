...
// Project:            SPAR
// Authors:            Yang
// Description:        Implemenation of IntegerCircuitParser 
//
// Modifications:
...
auto_ptr<Circuit> IntegerCircuitParser::ParseCircuit(const string& input) {
...
auto_ptr<Circuit> IntegerCircuitParser::ParseCircuit() {
  ParserState* parser_state = new ParserState();
  int lexcode;
  do {
    lexcode = yylex(scanner_);
