...
class HEAANCircuitParser;

class HEAANServer : public Baseline {

 public:
  // Initialize the baseline by passing it the HEAANCircuitParser
  HEAANServer(HEAANCircuitParser* p);

 private:
  virtual void ReadInputAndEvaluate();
  virtual void StorePublicKey();
