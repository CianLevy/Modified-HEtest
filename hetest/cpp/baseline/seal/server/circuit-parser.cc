...
// Project:            SPAR
// Authors:            Yang
// Description:        Implemenation of SEALCircuitParser 
//
// Modifications:
...
auto_ptr<Circuit> SEALCircuitParser::ParseCircuit(const string& input) {
...
auto_ptr<Circuit> SEALCircuitParser::ParseCircuit() {
  ParserState* parser_state = new ParserState();
  int lexcode;
  do {
    lexcode = yylex(scanner_);
