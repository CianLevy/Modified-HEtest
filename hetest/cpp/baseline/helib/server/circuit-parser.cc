...
// Project:            SPAR
// Authors:            Yang
// Description:        Implemenation of HelibCircuitParser 
//
// Modifications:
...
auto_ptr<Circuit> HelibCircuitParser::ParseCircuit(const string& input) {
...
auto_ptr<Circuit> HelibCircuitParser::ParseCircuit() {
  ParserState* parser_state = new ParserState();
  int lexcode;
  do {
    lexcode = yylex(scanner_);
