...
class UnaryGate: public Gate {
 ...
 public:
  ...
  void SetConstant(constant_value constant);

  virtual CtxtContainer Evaluate();

  const constant_value& constant() const { return constant_; }
 ...
 private:
  ...
  virtual CtxtContainer EvaluateImpl() = 0;
  
  bool evaluated_;
  constant_value constant_;
  GatePtr input_;
